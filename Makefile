...
# Build BPF code
xdp.bpf.o: xdp.h xdp.bpf.c $(LIBBPF_OBJ) | $(OUTPUT)
	$(CLANG) -g -O2 -target bpf -D__TARGET_ARCH_$(ARCH) $(INCLUDES) $(CLANG_BPF_SYS_INCLUDES) -c xdp.bpf.c -o $@
	$(LLVM_STRIP) -g $@

# Build application binary
xdp: xdp.bpf.o main.go
	$(GO) build -o $@ main.go
